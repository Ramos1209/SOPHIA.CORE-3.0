...
using SOPHIA_AUTENTICACAO.Models;
...
namespace SOPHIA_AUTENTICACAO.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        private async Task<UsuarioRespostaLogin> GerarJwt(string email)
        {
            ...
            var identityClaims = await ObterClaimsnUsuario(claims, user);
            ...
            IEnumerable<Claim> claims)
        {
            return new UsuarioRespostaLogin
            {
                ...
                UsuarioToken = new UsuarioToken
                {
                    Id = user.Id,
                    Email = user.Email,
                    Clains = claims.Select(c => new UsuarioClain { Types = c.Type, Value = c.Value })
                }
            };
        }

        private async Task<ClaimsIdentity> ObterClaimsnUsuario(ICollection<Claim> claims, IdentityUser user)
        {
